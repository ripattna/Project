...
def spark_execute(EXT_QRY_PATH, AUD_QRY_PATH, EXT_HDFS_PATH, ZIP_FLAG):
    ...
    if ZIP_FLAG.upper() == 'N':
        ...
        try:
            ...
            e_df.repartition(4).write.csv(EXT_HDFS_PATH, header=False, mode='overwrite', sep='', nullValue='\u0000', emptyValue='\u0000')
...
logging.basicConfig(
    format='%(asctime)s %(levelname)s %(message)s', filename='/home/log/dw_spark_ext.log', filemode='a',
